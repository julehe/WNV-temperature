...
n_exp = length(unique(data_lf_Atae$experiment_id))
n_total = nrow(data_lf_Atae)
...
plot1 = ggplot() + 
  ...
  geom_point(data = data_lf_Atae, aes(x = temperature, y = trait, color=as.factor(experiment_id)), size = 0.9, shape = 19) +
  labs(title= expression(paste(italic("Aedes taeniorhynchus"))))+
  geom_richtext(aes(x = 32, y = 145), 
...
n_exp = length(unique(data_lf_Cmol$experiment_id))
n_total = nrow(data_lf_Cmol)

plot2 = ggplot() + 
  geom_line(data = temp_df, aes(x = temp, y = mean), color = "black", linewidth = 0.6) +
  geom_ribbon(data = temp_df, 
              aes(x = temp, ymin = lowerCI, ymax = upperCI), fill = "black", alpha = 0.15) +
  geom_point(data = data_lf_Cmol, aes(x = temperature, y = trait, color=as.factor(experiment_id)), size = 0.9, shape = 19) +
...
n_exp = length(unique(data_lf_Cpal$experiment_id))
n_total = nrow(data_lf_Cpal)

plot3 = ggplot() + 
  geom_line(data = temp_df, aes(x = temp, y = mean), color = "black", linewidth = 0.6) +
  geom_ribbon(data = temp_df, 
              aes(x = temp, ymin = lowerCI, ymax = upperCI), fill = "black", alpha = 0.15) +
  geom_point(data = data_lf_Cpal, aes(x = temperature, y = trait, color=as.factor(experiment_id)), size = 0.9, shape = 19) +
...
n_exp = length(unique(data_lf_Cpip$experiment_id))
n_total = nrow(data_lf_Cpip)

plot4 = ggplot() + 
  geom_line(data = temp_df, aes(x = temp, y = mean), color = "black", linewidth = 0.6) +
  geom_ribbon(data = temp_df, 
              aes(x = temp, ymin = lowerCI, ymax = upperCI), fill = "black", alpha = 0.15) +
  geom_point(data = data_lf_Cpip, aes(x = temperature, y = trait, color=as.factor(experiment_id)), size = 0.9, shape = 19) +
...
n_exp = length(unique(data_lf_Cqui$experiment_id))
n_total = nrow(data_lf_Cqui)

plot5 = ggplot() + 
  geom_line(data = temp_df, aes(x = temp, y = mean), color = "black", linewidth = 0.6) +
  geom_ribbon(data = temp_df, 
              aes(x = temp, ymin = lowerCI, ymax = upperCI), fill = "black", alpha = 0.15) +
  geom_point(data = data_lf_Cqui, aes(x = temperature, y = trait, color=as.factor(experiment_id)), size = 0.9, shape = 19) +
...
n_exp = length(unique(data_lf_Cres$experiment_id))
n_total = nrow(data_lf_Cres)

plot6 = ggplot() + 
  geom_line(data = temp_df, aes(x = temp, y = mean), color = "black", linewidth = 0.6) +
  geom_ribbon(data = temp_df, 
              aes(x = temp, ymin = lowerCI, ymax = upperCI), fill = "black", alpha = 0.15) +
  geom_point(data = data_lf_Cres, aes(x = temperature, y = trait, color=as.factor(experiment_id)), size = 0.9, shape = 19) +
...
n_exp = length(unique(data_lf_Ctar$experiment_id))
n_total = nrow(data_lf_Ctar)

plot7 = ggplot() + 
  geom_line(data = temp_df, aes(x = temp, y = mean), color = "black", linewidth = 0.6) +
  geom_ribbon(data = temp_df, 
              aes(x = temp, ymin = lowerCI, ymax = upperCI), fill = "black", alpha = 0.15) +
  geom_point(data = data_lf_Ctar, aes(x = temperature, y = trait, color=as.factor(experiment_id)), size = 0.9, shape = 19) +
